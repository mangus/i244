...
<head>
    ...
    <title>I244 kaugõpe: 3. ja 4. praktikum</title>
...
<body>
    <div class="page-wrap container">
            ...
            <ol>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>andmed andmebaasis.</li>
                    </ul>
                    Kui mõni teema on segane, siis uurige koos juurde, küsige õppejõult ja tehke see selgeks.
                </li>
                <li>
        ...
        <div class="section">
            <h3>Lisaülesanded</h3>
            <p>
                Kui said kõik valmis ja jäi veel aega ülegi, siis siin mõned
                lisapunktide teenimise võimalused (kehtivad ka väljaspool praktikumi
                aega):
            </p>
            <ul>
                <li>Tee see käesolev praktikumi leht ilusamaks ning <em>pull request</em> õppejõule.</li>
                <li>Kujunda aine pealehte ning <em>pull request</em> õppejõule.</li>
                <li>Kirjuta aine pealehele "iganädalaste kodutööde" juurde taimer, mis näitab, palju aega on jäänud aruande esitamiseks.</li>
            </ul>
        </div>
    </div>
</body>
